...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_landcam_dev_pd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_landcam_dev_pd.inc';

  $databases['pd']['default'] = array(
    'driver' => 'mysql',
    'database' => 'pd',
    'username' => 'drupaluser',
    'password' => '',
